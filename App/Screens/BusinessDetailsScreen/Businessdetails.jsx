  ...
  return (
    ...
    <LinearGradient colors={['#A770EF', '#CF8BF3','#FDB99B']} style={styles.main}>
      ...
      <View>
        ...
        <Text style={{color:'white',marginLeft:20,alignItems:'center'}}><Fontisto name="email" size={24} color="black" style={styles.email}/></Text>
    ...
    visible={showModal}
    >
      <Bookingmodal onclose={handleClosemodel}/>
    </Modal>
